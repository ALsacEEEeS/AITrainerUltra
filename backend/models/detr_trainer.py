"""DETR trainer - object detection with DEtection TRansformer."""
...
class DETRTrainer(BaseTrainer):
    """DETR (DEtection TRansformer) object detection fine-tuning."""
    ...
    def train(self, **kwargs) -> Dict[str, Any]:
        self.load_model()
        return {"status": "ok", "model_type": "detr", "device": self.device_type}
